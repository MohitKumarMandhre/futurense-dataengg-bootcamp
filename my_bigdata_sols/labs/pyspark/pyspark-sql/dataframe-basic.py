...
def basic_df_example(spark):
    ...
    df = spark.read.json("/home/ubuntu/futurense_hadoop-pyspark/labs/dataset/customer/customer.json")
...
def schema_inference_example(spark):
    ...
    lines = sc.textFile("/home/ubuntu/futurense_hadoop-pyspark/labs/dataset/customer/customer.txt")
